...
variable "worker" {
    type = list(string)
    default = ["openshift-worker-0", "openshift-worker-1","openshift-worker-2"]
  }
variable "master" {
     type = list(string)
     default = ["openshift-master-0", "openshift-master-1","openshift-master-2"]
   }

#variable "worker-ht" {
#    type = list(string)
#    default = ["openshift-worker-1-ht"]
#  }
####workers
